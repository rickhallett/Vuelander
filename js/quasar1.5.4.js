...
(function(global, factory) {
  ...
  var getTouchTarget = isSSR === false && (
      client.is.ios === true ||
    ...
    methods: {
      ...
      __onTouchstart: function __onTouchstart(e) {
        if (touchTarget !== this.$el) {
          ...
          var target = getTouchTarget(touchTarget)
  ...
  function setPosition(cfg) {
    ...
    if (cfg.absoluteOffset === void 0) {
      ...
      var ref$1 = cfg.anchorEl.getBoundingClientRect()
    ...
    methods: {
      ...
      __getAllPanels: function __getAllPanels() {
        ...
        return this.panels.filter(
            function(panel) {
              return panel.componentOptions !== void 0 &&
  ...
  var QChip = Vue.extend({
    ...
    computed: {
      ...
      style: function style() {
        if (this.size !== void 0) {
          return {
            fontSize: this.size in sizes$2 ? ((sizes$2[this.size]) + "px") : this.size
          }
        }
      },
  ...
  */
  ...
  var QDrawer = Vue.extend({
    ...
    computed: {
      ...
      openDirective: function openDirective() {
        if (this.belowBreakpoint === true) {
          return [Object.assign({}, directiveTemplate,
  ...
  var QField = Vue.extend({
    ...
    data: function data() {
      return {
        ...
        innerLoading: false,
        targetUid: this.for === void 0 ? 'qf_' + uid$1() : this.for
      }
    },
      ...
      __onFinishEditing: function __onFinishEditing(e) {
        ...
        this.type !== 'file' && this.$nextTick(function() {
          if (this$1.$refs.input !== void 0) {
            this$1.$refs.input.value = this$1.innerValue
          }
        })
      },
  ...
  var prototypeAccessors = {
    ...
    hasSelection: {configurable: true},
    range: {configurable: true},
    parent: {configurable: true},
    blockParent: {configurable: true}
  }
    ...
    computed: {
      ...
      buttonDef: function buttonDef() {
        ...
        return {
          ...
          link: {
            cmd: 'link',
            disable: function(vm) { return vm.caret && !vm.caret.can('link') },
            icon: i.hyperlink,
            tip: e.hyperlink,
            key: 76
          },
          ...
          outdent: {
            type: 'no-state',
            disable: function(vm) { return vm.caret && !vm.caret.can('outdent') },
            cmd: 'outdent',
            icon: i.outdent,
            tip: e.outdent
          },
          indent: {
            type: 'no-state',
            disable: function(vm) { return vm.caret && !vm.caret.can('indent') },
            cmd: 'indent',
            icon: i.indent,
            tip: e.indent
          },
  ...
  var QForm = Vue.extend({
    ...
    methods: {
      ...
      focus: function focus() {
        var target = this.$el.querySelector('[autofocus]') ||
  ...
  var QLinearProgress = Vue.extend({
    ...
    computed: {
      sizeStyle: function sizeStyle() {
        if (this.size !== void 0) {
          return {height: this.size in sizes$3 ? ((sizes$3[this.size]) + "px") : this.size}
        }
      },
    ...
    render: function render(h) {
      ...
      var loop = function(i) {
        var
            ...
            exSelected = this$1.mouseModel > 0 && this$1.value >= i && this$1.mouseModel < i,
        ...
        if (optionsLength > 0 && this.useInput !== true && e.keyCode >= 48 && e.keyCode <= 90) {
          ...
          if (this.optionIndex !== index$1) {
            this.$nextTick(function() {
              ...
              this$1.scrollTo(index$1)

              if (index$1 >= 0 && this$1.useInput === true && this$1.fillInput === true) {
                var inputValue = this$1.__getOptionLabel(this$1.options[index$1])
        ...
        return {
          ...
          click: function(e) {
            if (this$1.hasDialog !== true) {
              ...
              if (
                  (this$1.useInput === true && e.target.classList.contains('q-select__input') !== true) ||
      ...
      addTableHeaderRowMeta: function addTableHeaderRowMeta(data) {
        ...
        if (this.multipleSelection === true) {
          Object.defineProperty(data, 'selected', {
            get: function() {
              return this$1.someRowsSelected === true
                  ? 'some'
        ...
        var
            ...
            child = bodyCell
                ? this.computedCols.map(function(col) {
                  return bodyCell(this$1.addBodyCellMetaData({
                    row: row,
                    col: col
                  }))
                })
        ...
        var item = this.$scopedSlots.item !== void 0
            ...
            : function(scope) {
              var child = scope.cols.map(
                  function(col) {
                    return h('div', {staticClass: 'q-table__grid-item-row'}, [
    ...
    render: function render(h) {
      ...
      return h(
          ...
          this.props === void 0 || this.props.header === true
              ? on
              : {on: on, class: this.props.__trClass},
          slot(this, 'default')
      )
    }
  })
  ...
  var QTree = Vue.extend({
    ...
    computed: {
      classes: function classes() {
        ...
        return (obj = {}, obj[("text-" + (this.color))] = this.color, obj['q-tree--dark'] = this.isDark, obj)
      },
        ...
        return h('div', {
          ...
          h('div', {
            ...
            on: {
              ...
              keypress: function(e) {
                if (shouldIgnoreKey(e) !== true) {
                  if (e.keyCode === 13) { this$1.__onClick(node, meta, e, true) } else if (e.keyCode === 32) { this$1.__onExpandClick(node, meta, e, true) }
                }
              }
            }
          }, [
      ...
      __addFiles: function __addFiles(e, files) {
        ...
        if (this.accept !== void 0) {
          files = Array.prototype.filter.call(files, function(file) {
            return this$1.extensions.some(function(ext) {
              return (
        ...
        return [
          h(QInput, {
            ...
            on: cache(this, 'prompt', {
              ...
              keyup: function(evt) {
                // if ENTER key
                if (this$1.prompt.type !== 'textarea' && isKeyCode(evt, 13) === true) {
                  this$1.onOk()
                }
              }
            })
